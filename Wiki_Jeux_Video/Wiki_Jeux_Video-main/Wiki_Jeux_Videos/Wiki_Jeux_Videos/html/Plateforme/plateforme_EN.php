...
<html lang="en">
	...
	<body>
		...
		<!-- L'en-tête de la page contient le titre du site et la navigation (liste des types de jeux et sélecteur de langue). -->
			<h1><a href="../Accueil/accueil_EN.php">Platform Games</a></h1>
			<nav>
			<!-- La navigation est composée d'une liste déroulante de types de jeux et d'un sélecteur de langue. -->
				<ul class="menu">
					<li><a href="../Accueil/accueil_EN.php">Types of Games <span>&#9662;</span></a>
							<ul class="submenu">
				...
				<ul class="language">
					<li>
					  <a class="liste2" href="../Plateforme/plateforme.php">
		...
		<footer>
			<div class="contacter">
			  ...
			  <h4><a class="contact" href="../Contact/contact_EN.php">Form</a></h4>
			</div>
			<div class="a_propos">
			  <h3>About Us</h3>
			  <h3>Junia Website</h3>
